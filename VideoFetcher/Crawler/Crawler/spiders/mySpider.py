...
class DataFetcher(scrapy.Spider):
    ...
    video_sources = pd.read_csv(r'C:\Users\zrf19\PycharmProjects\pythonProject\FinalEvent\RawDataURL\test.csv', encoding='utf-8')
    ...
    start_urls = ['https://constrain.adwetec.com/material/creative/video/' + url for url in urls[0:10]]
