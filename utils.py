...
def adjust_hyperparams(logger, params, sample_number, model_name, run_model, **kwargs):
    ...
    elif model_name == "VideoAttention" or model_name == "VideoAttentionEmbed":
        all_params = kwargs.get(
            "test_params",
            {
                "linear_length": 512,
    ...
    for i, model_param in enumerate(sample_params):
        ...
        elif model_name == "VideoAttentionEmbed":
            model = VideoAttentionEmbed(extra_length=config.extra_feat_length, hyperparams=model_param)
        elif model_name == "JointNet":
            hparams = {
                "video": {},
                "text": {},
